...
import {countries, getSampleData, tree} from './data';
...
export class AppComponent implements OnInit {
  ...
  // options
  showLegend = false;
  orientation: string = 'RL'; // LR, RL, TB, BT
  ...
  customLayout: Layout; // = new D3ForceDirectedLayout();
  layouts: any[] = [
    {
      label: 'Dagre',
      value: 'dagre',
  ...
  constructor() {
    Object.assign(this, {
      ...
      graph: {
        edges: this.data.Edges, nodes: this.data.Nodes
      }
    });
